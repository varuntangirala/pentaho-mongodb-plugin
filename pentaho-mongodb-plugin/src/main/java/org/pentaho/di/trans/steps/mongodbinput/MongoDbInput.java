...
public class MongoDbInput extends BaseStep implements StepInterface {
  ...
  public JSONObject testConnectionAction( Map<String, String> queryParams ) {
    ...
    if ( StringUtils.isEmpty( mongoDbInputMeta.getConnectionString() ) ) {
      return sendResponseWithMessage( response, BaseMessages.getString( PKG, "MongoDbInputDialog.ErrorMessage.MissingConnectionDetails", "Connection String" ) );
    }
  ...
  public JSONObject getDBNamesAction( Map<String, String> queryParams ) {
    JSONObject response = new JSONObject();
    List<String> dbNames;
  ...
  public JSONObject getCollectionNamesAction( Map<String, String> queryParams ) {
    JSONObject response = new JSONObject();
  ...
  public JSONObject getPreferencesAction( Map<String, String> queryParams ) {
    JSONObject response = new JSONObject();
  ...
  public JSONObject getTagSetAction( Map<String, String> queryParams ) {
    JSONObject response = new JSONObject();
    List<String> tags;
    ...
    if ( StringUtils.isEmpty( mongoDbInputMeta.getHostnames() ) ) {
      return sendResponseWithMessage( response,  BaseMessages.getString( PKG, "MongoDbInputDialog.ErrorMessage.MissingConnectionDetails", "host name(s)" ) );
    }
  ...
  public JSONObject testTagSetAction( Map<String, String> queryParams ) throws MongoDbException {
    JSONObject response = new JSONObject();
  ...
  public JSONObject getFieldsAction( Map<String, String> queryParams ) {
    ...
    if ( !StringUtils.isEmpty( missingConDetails ) ) {
      return sendResponseWithMessage( response, BaseMessages.getString( PKG, "MongoDbInputDialog.ErrorMessage.MissingConnectionDetails", missingConDetails ) );
    }
  ...
  private boolean validateRequest( JSONObject response, MongoDbInputMeta mongoDbInputMeta ) {
    if ( mongoDbInputMeta != null ) {
      ...
      if ( isConnectionDetailsEmpty ) {
        ...
        response.put( ERROR_MESSAGE, BaseMessages.getString( PKG, "MongoDbInputDialog.ErrorMessage.MissingConnectionDetails", errorString ) );
        response.put( StepInterface.ACTION_STATUS, StepInterface.FAILURE_RESPONSE );
        return false;
      }
    }
